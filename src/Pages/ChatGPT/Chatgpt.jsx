    ...
    <div className='chatgptContainer'>
      <div className="chatgptWrapper">
        ...
        <div className="chatgptInputSection">
          <input type="text" placeholder="Type here and kindly wait for the reply. . ." className="chatgptInput" value={inputValue} onChange={(e) => setInputValue(e.target.value)} onKeyDown={(e) => handleEnterPress(e)} />
